...
const Desktop = () => {
    ...
    return (
        <div ref={desktop} className={styles.desktop}>
            ...
            <DesktopIcon title="Recycle Bin" iconLarge="/icon__recycle_bin--large.png" icon="/icon__recycle_bin.png" content="" width={500} height={350} top={500} left={500} active={true} />
        </div>
    );
};
